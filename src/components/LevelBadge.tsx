 ...
 */
export function LevelBadge({ progress }: { progress: LevelProgress }) {
  return (
    <div className="pixel-card flex items-center gap-3 bg-nes-green px-4 py-2 lg:gap-4 lg:px-5 lg:py-3">
